    ...
    return (
        <Routes>
            ...
            <Route path={ROUTES.hubProperties}
                   ...
                   element={<HubPropertiesPage hub={props.hub}/>}
            />,
            <Route path={ROUTES.ports}
                   key={ROUTES.ports}
                   element={<PortsPage hub={props.hub}/>}
            />,
            <Route path={ROUTES.motors}
                   key={ROUTES.motors}
                   element={<MotorPage hub={props.hub}/>}
            />,
            <Route path={ROUTES.latency}
                   key={ROUTES.latency}
                   element={<LatencyPage hub={props.hub}/>}
            />,
            <Route path={ROUTES.ledColor}
                   key={ROUTES.ledColor}
                   element={<LedColorPage hub={props.hub}/>}
            />
        </Routes>
    );
}
