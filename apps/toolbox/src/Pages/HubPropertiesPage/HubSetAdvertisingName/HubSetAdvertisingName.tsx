...
import styles from './HubSetAdvertisingName.module.scss';
import { useHubStore } from '../../../Store';

export function HubSetAdvertisingName(props: { name: string; hub: IHub }): ReactElement {
  const id = useId();
