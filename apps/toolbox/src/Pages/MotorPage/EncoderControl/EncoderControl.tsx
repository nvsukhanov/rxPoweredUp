...
export function EncoderControl(props: { hub: IHub; portId: number | undefined }): ReactElement {
  ...
  const handleEncoderOffsetChange = (event: ChangeEvent<HTMLInputElement>): void => {
  ...
  const handleEncoderOffsetApply = (): void => {
    ...
    props.hub.motors
      .setZeroPositionRelativeToCurrentPosition(props.portId, encoderOffset)
