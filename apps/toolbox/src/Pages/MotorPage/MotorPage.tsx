...
export function MotorPage(props: { hub: IHub | undefined }): ReactElement {
  ...
  return (
    <>
      ...
      <section>
        ...
        <div className={styles['featureSection']}>
          <PositionControl hub={props.hub} portId={portId}></PositionControl>
        </div>
      </section>
      <section>
        <h2>Position read</h2>
        <div className={styles['featureSection']}>
          <PositionInfo hub={props.hub} portId={portId}></PositionInfo>
        </div>
      </section>
      <section>
        <h2>Speed controls</h2>
        <div className={styles['featureSection']}>
          <SpeedControl hub={props.hub} portId={portId}></SpeedControl>
        </div>
      </section>
      <section>
        <h2>Encoder</h2>
        <div className={styles['featureSection']}>
          <EncoderControl hub={props.hub} portId={portId}></EncoderControl>
        </div>
      </section>
      <section>
        <h2>Servo sequence</h2>
        <div className={styles['featureSection']}>
          <ServoSequence hub={props.hub} portId={portId}></ServoSequence>
        </div>
      </section>
      <section>
        <h2>Motor power controls (write direct)</h2>
        <div className={styles['featureSection']}>
          <PowerControl hub={props.hub} portId={portId}></PowerControl>
        </div>
      </section>
    </>
  );
