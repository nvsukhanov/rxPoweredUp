...
export function PositionInfoItem(props: {
  canEditMode: boolean;
  canRead: boolean;
  ...
  return (
    <>
      ...
      <div>
        <button type={'button'} disabled={!props.canRead} onClick={props.read}>
          Read
        </button>
        <button type={'button'} disabled={!props.canSubscribe} onClick={props.subscribe}>
          Subscribe
        </button>
        <button type={'button'} disabled={!props.canUnsubscribe} onClick={props.unsubscribe}>
          Unsubscribe
        </button>
      </div>
    </>
