...
export function ServoSequence(props: { hub: IHub; portId: number | undefined }): ReactElement {
  ...
  return (
    <section>
      <button disabled={props.portId === undefined || isCommandRunning} onClick={handleRunClick}>
        Run
      </button>
    </section>
  );
