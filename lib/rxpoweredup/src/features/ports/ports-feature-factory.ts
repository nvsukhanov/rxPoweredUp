...
export class PortsFeatureFactory implements IPortsFeatureFactory {
  constructor(
    @inject(PORT_INFORMATION_REQUEST_MESSAGE_FACTORY)
    ...
    @inject(PORT_INFORMATION_REPLY_PARSER)
    private readonly portInformationRequestReplyParser: IReplyParser<MessageType.portInformation>,
    ...
    @inject(PORT_MODE_INFORMATION_REQUEST_MESSAGE_FACTORY)
    ...
    private readonly portInputFormatSetupSingleMessageFactory: IPortInputFormatSetupMessageFactory,
    @inject(PORT_MODE_INFORMATION_REPLY_PARSER)
    private readonly portModeInformationReplyParserService: IReplyParser<MessageType.portModeInformation>,
    @inject(PORT_RAW_VALUE_REPLY_PARSER)
    private readonly portRawValueReplyParser: IReplyParser<MessageType.portValueSingle>,
    @inject(VIRTUAL_PORT_SETUP_MESSAGE_FACTORY)
  ...
  public create(
    ...
    const attachedIOCache = new AttachedIoRepliesCache(attachedIOReplies$, onHubDisconnected);
