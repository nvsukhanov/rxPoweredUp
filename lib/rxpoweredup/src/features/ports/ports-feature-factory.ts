...
export class PortsFeatureFactory implements IPortsFeatureFactory {
  ...
  public create(
    ...
    const portInformationReplies$ = this.messageListenerFactory.create(characteristicDataStream, this.portInformationRequestReplyParser, onHubDisconnected);

    const portRawValueReplies = this.messageListenerFactory.create(characteristicDataStream, this.portRawValueReplyParser, onHubDisconnected);

    const attachedIOReplies$ = this.messageListenerFactory.create(characteristicDataStream, this.attachedIoReplyParser, onHubDisconnected);
