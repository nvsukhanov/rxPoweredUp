...
export class HubPropertiesOutboundMessageFactory implements IHubPropertiesMessageFactory {
  public setProperty(property: WritableHubProperties, value: number[]): RawMessage<MessageType.properties> {
    return {
      header: {
        messageType: MessageType.properties,
      },
      payload: Uint8Array.from([property, HubPropertyOperation.setProperty, ...value]),
    };
  }
  ...
  public requestPropertyUpdate(property: HubProperty): RawMessage<MessageType.properties> {
    return {
      ...
      payload: Uint8Array.from([property, HubPropertyOperation.requestUpdate]),
    };
  }
  ...
  public createSubscriptionMessage<TProp extends SubscribableHubProperties>(
    ...
    return {
      ...
      payload: Uint8Array.from([property, HubPropertyOperation.enableUpdates]),
    };
  }
  ...
  public createUnsubscriptionMessage<TProp extends SubscribableHubProperties>(
    ...
    return {
      ...
      payload: Uint8Array.from([property, HubPropertyOperation.disableUpdates]),
    };
  }
}
