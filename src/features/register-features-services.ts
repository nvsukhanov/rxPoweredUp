...
import { HUB_ACTIONS_FEATURE_FACTORY, HUB_PROPERTY_FEATURE_FACTORY, MOTORS_FEATURE_FACTORY, PORTS_FEATURE_FACTORY, SENSORS_FEATURE_FACTORY } from '../hub';
...
import { SensorsFeatureFactory } from './sensors';
...
export function registerFeaturesServices(
    ...
    container.register(SENSORS_FEATURE_FACTORY, SensorsFeatureFactory);
}
